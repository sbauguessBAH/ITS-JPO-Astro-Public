...
export const navigation: NavigationItem[] = [
    ...
    pages: [
      { name: "About ITS JPO", url: "/about", isEnabled: true },
      {
        ...
        pages: [
          ...
          {
            name: "ITS Specialists in Field Offices",
            url: "https://www.fhwa.dot.gov/resourcecenter/teams/operations/index.cfm",
            isExternal: true,
          },
        ],
      },
    ...
    pages: [
      {
        ...
        pages: [
          ...
          {
            name: "Complete Streets Artificial Intelligence Initiative",
            url: "/research-areas/Artificial-Intelligence/Complete-Streets-AI",
          },
        ],
      },
  ...
  },
  {
    ...
    url: "/news-info",
    pages: [
      { name: "Latest News from ITS JPO", url: "/news-info/news", isEnabled: true },
...
export function findBreadcrumbItems(pathname: string): BreadcrumbItem[] {
  ...
  let navigationItem: AnyNavigationItem | undefined = navigation.find((section) =>
...
export function findNavigationItem(
  pathname: string
): [ChildNavigationItem | undefined, ChildNavigationItem | undefined, ChildNavigationItem | undefined] {
  const trimmedPathname = getTrimmedPathname(pathname);
