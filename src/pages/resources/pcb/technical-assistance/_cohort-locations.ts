/**
 * Mapping of state map abbreviations to cohort information
 *
 * Thought this would help since some of the counts in the tooltips were wrong
 * Also you instantiate 35+ tooltips when it could just be one
 * And you can even add the SVG code in here
 * Hovering over Kansas shows the Maine locations
 * Also the dots for some states like California or Washington don't line up with the locations count
 */
...
export type State = {
  ...
  drawable: IsCircle | IsPath;
};

/** States mapped to abbreviations */
export const states: Record<string, State> = {
  ...
  KY: {
    members: [
      ...
      {
        agency: "Kentucky Transportation Center (University of Kentucky)",
        x: 663,
        y: 305,
      },
    ],
  ...
  NY: {
    members: [
      { agency: "New York State DOT", x: 830, y: 170 },
      { agency: "New York City DOT", x: 812, y: 150 },
      {
        agency: "Niagara International Transportation Technology Coalition",
        x: 777,
        y: 162,
      },
    ],
  ...
  OH: {
    members: [
      { agency: "Ohio DOT", x: 676, y: 215 },
      { agency: "City of Marysville", x: 684, y: 227 },
      { agency: "City of Dublin", x: 695, y: 221 },
      { agency: "City of Fairlawn", x: 710, y: 218 },
    ],
    state: "Ohio",
    drawable: {
      type: "path",
  ...
  OR: {
    members: [{ agency: "Oregon DOT", x: 61, y: 78 }],
    state: "Oregon",
    drawable: {
      type: "path",
  ...
  TN: {
    members: [
      { agency: "City of Chattanooga", x: 693, y: 340 },
      { agency: "Tennessee DOT", x: 649, y: 339 },
      { agency: "Nashville DOT", x: 672, y: 357 },
      { agency: "University of Tennessee Chattanooga", x: 676, y: 358 },
    ],
    state: "Tennessee",
    drawable: {
      type: "path",
  ...
  TX: {
    members: [
      { agency: "Texas DOT", x: 473, y: 420 },
      { agency: "Texas A&M Transportation Institute", x: 485, y: 448 },
      { agency: "City of Dallas", x: 466, y: 455 },
    ],
    state: "Texas",
    drawable: {
      type: "path",
  ...
  // DC must be at end of draw order
  DC: {
    members: [
      {
        agency: "Washington D.C. DOT",
        x: 801.6,
        y: 252.1,
      },
    ],
