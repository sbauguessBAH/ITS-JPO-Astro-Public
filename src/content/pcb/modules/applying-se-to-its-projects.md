...
The goal of the module is to emphasize the benefits of understanding and using a systems engineering approach, promote systems thinking, provide an over view of the critical documents developed when designing ITS solutions for transportation problems, and ultimately show how using a systems engineering approach leads to comprehensive, quality ITS deployments. More detailed resources are available, including those offered through the [Federal Highway Administration (FHWA) National Highway Institute (NHI)](https://fhwanhi.geniussis.com/PublicWelcome.aspx).
